...
if($RecourdCount > 0){
	...
	$strHtml = "<table id='grid-data' name='grid-data' class='table table-condensed table-hover table-striped' >
	<thead>
 		<tr>
	...
	for($i = 0; $i < $RecourdCount; $i++){
		...
		$strHtml .= "<tr>
						...
						<select class='form-control' >        
								...
								<option value='TRA'>EN TRAMITE</option>
